...
- **黑色** - 黑色眼睛
- **白色** - 白色眼睛
- **自定义** - 点击自定义按钮可以自由设置眼睛纹理（纹理类型选择将被禁用）
...
有关详细用法，请参阅以下指南：
- [🎭面部混合形状预设（快速入门）]({{ site.baseurl }}/menno/zh/mas-settings/face/preset-quickstart/) - 基本用法
- [🎭面部形状键预设（详细指南）]({{ site.baseurl }}/menno/zh/mas-settings/face/preset-guide/) - 高级用法和技术细节
