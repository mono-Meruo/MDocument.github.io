...
形状键是改变3D模型形状的功能。Menno模型总共实现了884个形状键，允许对角色表情和身体形状进行详细调整。

## 形状键概述

### 面部形状键（总计832个，其中功能性形状键608个）
...
## Perfect-Sync形状键说明（实验中）

Perfect-Sync是一组实验性的形状键，用于实现更自然的表情同步。可以实现以下精细的表情控制：
